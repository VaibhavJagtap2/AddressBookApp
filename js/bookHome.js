...
const createInnerHtml = () => {
    ...
    for ( const addressBookData of addressBookList) {
        ...
        <tr class="trr">
            ...
            <td>
                <img id="${addressBookData._id}" onclick="remove(this)" alt="delete" src="C:/Users/Admin/AddressbookApp/assets/icons/delete-black-18dp.svg">
                <img id="${addressBookData._id}" onclick="update(this)" alt="edit" src="C:/Users/Admin/AddressbookApp/assets/icons/create-black-18dp.svg">
            </td>
        </tr>
    `;
    }
